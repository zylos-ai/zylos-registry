...
| [wecom](https://github.com/zylos-ai/zylos-wecom) | 通讯 | 企业微信（WeCom / WeChat Work）—— 企业平台，配置在企业微信侧完成；**非**个人微信（个人号请用 `wechat`） |
...
| [wechat](https://github.com/zylos-ai/zylos-wechat) | 通讯 | 个人微信（微信个人号）—— 二维码登录、多账号、无企业侧配置；**非**企业微信（企业号请用 `wecom`） |
